...
COMMENT ELE: les algos seraient plus lisibles si les variables avaient des noms lisibles:
SP-> Shared_plan, g_r -> goal_robot , WS -> word_state, TS -> ??, DB divergent_belief,a -> action, etc…  là je suis obligé d'aller chercher dans les pavés de txt en dessous pour comprendr l'algo. Aussi, pk tu as une notation de fonction pour MS(H) et pas une notation indicée?
